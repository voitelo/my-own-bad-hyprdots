...
choice=$(echo -e "$menu" | rofi -config /home/leg/.config/rofi/application-launcher/config.rasi -style /home/leg/.config/rofi/application-launcher/theme.rasi -dmenu -p "Window Manager:")
...
if [[ "$choice" == "Minimize Window" ]]; then
  ...
  win_choice=$(echo -e "$win_list" | rofi -config /home/leg/.config/rofi/application-launcher/config.rasi -style /home/leg/.config/rofi/application-launcher/theme.rasi -dmenu -p "Select window to minimize:")
...
if [[ "$choice" == "Un-minimize Window" ]]; then
  ...
  un_choice=$(echo -e "$unmin_menu" | rofi -config /home/leg/.config/rofi/application-launcher/config.rasi -style /home/leg/.config/rofi/application-launcher/theme.rasi -dmenu -p "Select window to un-minimize:")
  [[ -z "$un_choice" ]] && exit
