...
# --- Configuration ---
art_file="$HOME/.cache/nowplaying/album_art.jpg"
fallback_art_file="$HOME/.cache/nowplaying/fallback_album_art.jpg"
cache_file="$HOME/.cache/nowplaying/song_title.cache"
