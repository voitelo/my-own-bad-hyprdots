  ...
  -- Color highlight (inline color blocks)
  {
    ...
    config = function()
      require("nvim-highlight-colors").setup({
        render = 'virtual',               -- Use virtual text for color blocks
        virtual_text = '■',               -- Small block symbol
        enable_tailwind = true,           -- Optional if you use Tailwind
        enable_named_colors = true,       -- Shows named CSS colors too
      })
    end
  },
})
